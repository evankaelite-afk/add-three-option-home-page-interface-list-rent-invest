...
import type { Listing as _Listing, Property as _Property, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, WaitlistEntry as _WaitlistEntry } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createListing(arg0: string, arg1: string, arg2: bigint, arg3: Array<Uint8Array>): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async joinWaitlist(arg0: string, arg1: string, arg2: string, arg3: string | null): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.joinWaitlist(arg0, arg1, arg2, to_candid_opt_n14(this._uploadFile, this._downloadFile, arg3));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_WaitlistEntry_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _WaitlistEntry): WaitlistEntry {
    return from_candid_record_n13(_uploadFile, _downloadFile, value);
}
function from_candid_opt_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Property]): Property | null {
...
function from_candid_opt_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Listing]): Listing | null {
    return value.length === 0 ? null : value[0];
}
function from_candid_record_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        investorType: record_opt_to_undefined(from_candid_opt_n6(_uploadFile, _downloadFile, value.investorType))
    };
}
...
function from_candid_vec_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_WaitlistEntry>): Array<WaitlistEntry> {
    return value.map((x)=>from_candid_WaitlistEntry_n12(_uploadFile, _downloadFile, x));
}
...
function to_candid_record_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        email: value.email,
        phoneNumber: value.phoneNumber,
        investorType: value.investorType ? candid_some(value.investorType) : candid_none()
    };
}
